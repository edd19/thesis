...
\todo[inline]{Give other examples as industry automation or smart cities, or healthcare.}
...
\begin{table}
  ...
  \end{tabularx}
  \caption{Devices characteristics}
