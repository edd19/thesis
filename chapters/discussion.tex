...
All those points are to be taken into account if the purpose is to monitor a network and showcase accurate data. In our case though, no tempering was possible, as we know exactly what kind of data passes through the network and which device creates the flows.
